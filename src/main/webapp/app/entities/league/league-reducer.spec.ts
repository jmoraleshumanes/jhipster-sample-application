...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAGUE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LEAGUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LEAGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAGUE actions', async () => {
      const expectedActions = [
        {

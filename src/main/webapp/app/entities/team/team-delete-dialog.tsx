...
export const TeamDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.team.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.team.delete.question" interpolate={{ id: teamEntity.id }}>

...
class TeamResourceIT {
     ...
     *
     * @see com.mycompany.myapp.repository.search.TeamSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchTeam() throws Exception {
        ...
        // Initialize the database
        teamRepository.saveAndFlush(team);
        when(mockTeamSearchRepository.search(queryStringQuery("id:" + team.getId()))).thenReturn(Collections.singletonList(team));
